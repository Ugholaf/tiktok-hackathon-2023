...
export type GetApiKeyListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetApiKeyListQuery = { __typename?: 'Query', getApiKeyList: Array<{ __typename?: 'ApiKeyPayload', webhookUrl: string, type: ApiKeyType, prefix: string, merchantId: string, label: string }> };
...
export type MerchantGetQrDetailsQuery = { __typename?: 'Query', merchantGetQRDetails: { __typename?: 'MerchantPayment', amount: number, merchantId: string, orderId: string, currency: Currency, merchant: { __typename?: 'User', username: string } } };
...
export type MerchantPayQrMutationVariables = Exact<{
  merchantPayQrId: Scalars['String']['input'];
}>;


export type MerchantPayQrMutation = { __typename?: 'Mutation', merchantPayQR: { __typename?: 'MerchantPayment', amount: number, merchant: { __typename?: 'User', username: string } } };
...
export const GetApiKeyListDocument = gql`
    query GetApiKeyList {
  getApiKeyList {
    webhookUrl
    type
...
/**
 * __useGetApiKeyListQuery__
 *
 * To run a query within a React component, call `useGetApiKeyListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetApiKeyListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetApiKeyListQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetApiKeyListQuery(baseOptions?: Apollo.QueryHookOptions<GetApiKeyListQuery, GetApiKeyListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetApiKeyListQuery, GetApiKeyListQueryVariables>(GetApiKeyListDocument, options);
      }
export function useGetApiKeyListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetApiKeyListQuery, GetApiKeyListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetApiKeyListQuery, GetApiKeyListQueryVariables>(GetApiKeyListDocument, options);
        }
export type GetApiKeyListQueryHookResult = ReturnType<typeof useGetApiKeyListQuery>;
export type GetApiKeyListLazyQueryHookResult = ReturnType<typeof useGetApiKeyListLazyQuery>;
export type GetApiKeyListQueryResult = Apollo.QueryResult<GetApiKeyListQuery, GetApiKeyListQueryVariables>;
...
export const MerchantPayQrDocument = gql`
    mutation MerchantPayQR($merchantPayQrId: String!) {
  merchantPayQR(id: $merchantPayQrId) {
    merchant {
      username
    }
    amount
    ...
    `;
export type MerchantPayQrMutationFn = Apollo.MutationFunction<MerchantPayQrMutation, MerchantPayQrMutationVariables>;

/**
 * __useMerchantPayQrMutation__
 *
 * To run a mutation, you first call `useMerchantPayQrMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useMerchantPayQrMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [merchantPayQrMutation, { data, loading, error }] = useMerchantPayQrMutation({
 *   variables: {
 *      merchantPayQrId: // value for 'merchantPayQrId'
 *   },
 * });
 */
export function useMerchantPayQrMutation(baseOptions?: Apollo.MutationHookOptions<MerchantPayQrMutation, MerchantPayQrMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<MerchantPayQrMutation, MerchantPayQrMutationVariables>(MerchantPayQrDocument, options);
      }
export type MerchantPayQrMutationHookResult = ReturnType<typeof useMerchantPayQrMutation>;
export type MerchantPayQrMutationResult = Apollo.MutationResult<MerchantPayQrMutation>;
export type MerchantPayQrMutationOptions = Apollo.BaseMutationOptions<MerchantPayQrMutation, MerchantPayQrMutationVariables>;
...
export const RevokeApiKeyDocument = gql`
    mutation RevokeApiKey($prefix: String!) {
  revokeApiKey(prefix: $prefix)
}
    `;
...
export const GenerateApiKeyDocument = gql`
    mutation GenerateApiKey($label: String!, $type: ApiKeyType!, $webhookUrl: String!) {
  generateApiKey(label: $label, type: $type, webhookUrl: $webhookUrl)
}
    `;
